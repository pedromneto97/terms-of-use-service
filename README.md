...
- **Full observability** - Open Telemetry integration for tracing and logging
...
### Choose Your Stack
Before building, decide which adapters you need. You must select exactly **one from each category**:
